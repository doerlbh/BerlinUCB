...
function [new_x, new_y] = K_nonstationary(x,y,window)
...
for t = 1:n-1
    ...
    [x_t_1, y_t_1, ~, x_first_half_first, y_first_half_first, z_first_half_first, chosen_size_1] = K_pair_shuffle_group(x_first_half_first,y_first_half_first,z_first_half_first,window,seq_first(t),1);
    disp(['-> finish first main cluster chosing']);
    
    [x_t_2, y_t_2, ~, x_first_half_second, y_first_half_second, z_first_half_second, chosen_size_2] = K_pair_shuffle_group(x_first_half_second,y_first_half_second,z_first_half_second,window,seq_second(t),1);
