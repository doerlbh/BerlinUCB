...
[data,opts] = nonstationary(data,opts,batchsize,'reward',-1);
...
save('output/test.mat','res_a','res_b','res_c','res_d','res_e','res_f','res_g','res_h','res_i','data','opts');
